...
const createdFeedFollow = `-- name: CreatedFeedFollow :one
...
func (q *Queries) CreatedFeedFollow(ctx context.Context, arg CreatedFeedFollowParams) (FeedFollow, error) {
	row := q.db.QueryRowContext(ctx, createdFeedFollow,
		arg.ID,
		arg.CreatedAt,
		arg.UpdatedAt,
		arg.UserID,
